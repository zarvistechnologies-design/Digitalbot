...
export function Footer() {
  ...
  const services = [
    ...
    { name: "Voice AI for Business", href: "/services/voice-ai-business", icon: Building2, gradient: "from-orange-500 to-orange-500", description: "Enterprise AI solutions" },
    ...
    { name: "AI Call Center", href: "/services/ai-call-center", icon: Phone, gradient: "from-orange-500 to-orange-500", description: "Automated call handling" },
  ...
  return (
    <footer className="relative bg-gradient-to-b from-white to-[#fafbff] border-t border-orange-100/30 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Enhanced Premium Feature Banner - orange/orange */}
        <div className="py-12 mb-8">
          <div className="relative glass-strong bg-gradient-to-r from-orange-500/90 via-orange-500/90 to-orange-600/90 rounded-3xl p-8 shadow-2xl shadow-orange-500/20 overflow-hidden group border border-orange-400/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 py-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Enhanced Trust Badges - orange/orange */}
            ...
            {/* Enhanced Social Media - orange/orange */}
            <div>
              ...
              <div className="flex items-center gap-2">
                {[
                  { icon: Twitter, link: "https://twitter.com/digitalbot_ai", label: "Twitter", color: "from-orange-500 to-orange-500" },
                  { icon: Linkedin, link: "https://linkedin.com/company/digitalbot-ai", label: "LinkedIn", color: "from-orange-500 to-orange-600" },
                  { icon: Instagram, link: "https://www.instagram.com/digitalbot._ai?utm_source=qr&igsh=MTc3emoxbmdqdmVz", label: "Instagram", color: "from-pink-500 to-orange-500" },
                  { icon: Facebook, link: "https://www.facebook.com/profile.php?id=61583885495540", label: "Facebook", color: "from-orange-500 to-orange-500" },
          ...
          {/* Enhanced AI Services Grid - orange/orange */}
          <div className="lg:col-span-8">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-gradient-to-br from-orange-500 via-orange-500 to-orange-600 rounded-xl shadow-lg shadow-orange-500/20 animate-pulse">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-fr">
              {services.map((service, idx) => {
                ...
                const colorSets = [
                  { gradient: 'from-orange-500 via-orange-500 to-orange-600', border: 'border-orange-200/30', iconBg: 'from-orange-50/80 to-white/60' },
                  { gradient: 'from-orange-500 via-orange-500 to-orange-600', border: 'border-orange-200/30', iconBg: 'from-orange-50/80 to-white/60' },
                  { gradient: 'from-orange-500 via-orange-500 to-orange-600', border: 'border-orange-200/30', iconBg: 'from-orange-50/80 to-white/60' },
                  { gradient: 'from-orange-500 via-orange-500 to-orange-600', border: 'border-orange-200/30', iconBg: 'from-orange-50/80 to-white/60' },
                  { gradient: 'from-orange-500 via-orange-500 to-orange-600', border: 'border-orange-200/30', iconBg: 'from-orange-50/80 to-white/60' },
                  ...
                  <ul className="space-y-2.5">
                    {column.links.map((link, linkIdx) => (
                      <li key={linkIdx}>
                        ...
                        >
                          <span className="w-0 h-px bg-gradient-to-r from-orange-500 to-orange-500 group-hover:w-4 transition-all duration-300" />
                          {link.name}
                        </Link>
                      </li>
                    ))}
        ...
        <div className="border-t border-orange-100/30 pt-8 pb-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            {/* Enhanced Copyright with Animation - orange/orange */}
