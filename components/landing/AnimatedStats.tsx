...
function AnimatedStat({ value, suffix = '', prefix = '', label, icon: Icon, duration = 2, decimals = 0, color = 'from-indigo-500 to-violet-500', bgColor = 'from-indigo-50 to-violet-50/50' }: StatProps) {
...
const stats = [
  { value: 10, suffix: 'M+', label: 'Calls Handled', icon: Phone, color: 'from-indigo-500 to-violet-500', bgColor: 'from-indigo-50 to-violet-50/50' },
  ...
  { value: 750, suffix: 'ms', prefix: '<', label: 'Response Time', icon: Zap, color: 'from-indigo-500 to-violet-500', bgColor: 'from-indigo-50 to-violet-50/50' },
  ...
  { value: 300, suffix: '%', label: 'Average ROI', icon: TrendingUp, color: 'from-indigo-500 to-violet-500', bgColor: 'from-indigo-50 to-violet-50/50' },
]
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-[#fafbff] via-white to-[#f0f0ff] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        >
          <span className="inline-block px-4 py-2 bg-indigo-50/60 text-indigo-700 rounded-full text-sm font-semibold mb-4 border border-indigo-200/40">
            Platform Performance
          </span>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Numbers That <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-violet-500">Speak for Themselves</span>
          </h2>
