        ...
        >
          ...
          >
            ...
            <div className="relative z-10 text-center">
              {/* Gift Icon */}
              <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-orange-500/30">
