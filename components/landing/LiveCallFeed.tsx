        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 mb-8">
              <p className="text-orange-200 text-sm font-medium mb-2">Total Calls Handled</p>
              <div className="text-4xl md:text-5xl font-black text-white tabular-nums">
                {totalCalls.toLocaleString()}
              </div>
              <p className="text-orange-200 text-sm mt-2">And counting...</p>
            </div>
                ...
                <AnimatePresence mode="popLayout">
                  {calls.map((call) => (
                    <motion.div
                      ...
                      className="bg-white/5 backdrop-blur rounded-xl p-4 border border-white/10 hover:border-orange-500/30 transition-colors"
                    >
