  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute -inset-1 rounded-full border-2 border-orange-400/50 animate-pulse"></span>
        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-gradient-to-br from-slate-900 via-orange-900/90 to-slate-900 rounded-3xl p-8 max-w-md w-full shadow-2xl border border-orange-500/30"
            ...
            >
              ...
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 bg-orange-500/20 px-4 py-2 rounded-full mb-4">
                  ...
                  <span className="text-orange-300 text-sm font-medium">Live AI Demo</span>
                </div>
              ...
              {isCallActive && (
                <div className="text-center mb-4">
                  <span className="text-orange-400 font-mono text-lg">{formatTime(callDuration)}</span>
                </div>
              )}
