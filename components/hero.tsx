...
export default function Hero() {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            // Initial states
            if (header) gsap.set(header as gsap.TweenTarget, { opacity: 0, y: 30 });
            if (line) gsap.set(line as gsap.TweenTarget, { scaleX: 0, transformOrigin: 'left center' });
            ...
            ScrollTrigger.create({
                ...
                onEnter: () => {
                    ...
                    if (header) {
                        gsap.to(header as gsap.TweenTarget, {
                            opacity: 1,
                            y: 0,
                            duration: 0.6,
                            ease: "power2.out"
