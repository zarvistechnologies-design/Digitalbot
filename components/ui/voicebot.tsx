        ...
        {isCallActive && (
          <div className="mt-6 flex flex-col items-center gap-3">
            ...
            <div className="flex gap-2 mt-2">
              <div className={`w-2 h-8 bg-blue-400 rounded ${isSpeaking ? '' : 'animate-pulse'}`} style={{animationDelay: '0ms'}}></div>
              <div className={`w-2 h-12 bg-blue-500 rounded ${isSpeaking ? '' : 'animate-pulse'}`} style={{animationDelay: '150ms'}}></div>
              <div className={`w-2 h-10 bg-blue-400 rounded ${isSpeaking ? '' : 'animate-pulse'}`} style={{animationDelay: '300ms'}}></div>
            </div>
          </div>
        )}
