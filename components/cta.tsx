...
export function CTA() {
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#fafbff] via-white to-white">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-indigo-100/40 to-transparent rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-6xl">
        
        {/* Section Header */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 glass-card bg-indigo-50/60 border-indigo-200/40 px-4 py-2 rounded-full mb-6">
            <Award className="w-4 h-4 text-indigo-600" />
            <span className="text-sm font-semibold text-indigo-600">Trusted Worldwide</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="flex justify-center lg:justify-start">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl shadow-indigo-100/20 p-8 w-full max-w-md border border-white/40 hover:shadow-2xl transition-shadow duration-500">
              {/* Card Header */}
              <div className="flex items-center gap-2 mb-8">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center">
                  <Shield className="w-4 h-4 text-white" />
                </div>
                <span className="text-lg font-bold text-indigo-500">Trusted Platform</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {stats.map((stat, idx) => (
                  <div 
                    key={idx}
                    className="group p-5 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-indigo-100/30 hover:border-indigo-300 hover:shadow-lg hover:shadow-indigo-100/50 transition-all duration-300 text-center cursor-default"
                  >
                    <div className="text-2xl sm:text-3xl font-bold text-indigo-500 group-hover:scale-110 transition-transform duration-300">
                      {stat.number}
                    </div>
