...
export function CTA() {
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-br from-blue-50/50 via-white to-white">
      {/* Background decorations */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-blue-100/60 to-transparent rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-6xl">
        
        {/* Section Header */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-100 px-4 py-2 rounded-full border border-blue-200 mb-6">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight">
            ...
            <span className="block bg-gradient-to-r from-blue-500 to-blue-500 bg-clip-text text-transparent">
          ...
          <div className="flex justify-center lg:justify-start">
            <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 p-8 w-full max-w-md border border-gray-100/80 hover:shadow-2xl transition-shadow duration-500">
              ...
              <div className="flex items-center gap-2 mb-8">
                ...
                <span className="text-lg font-bold text-blue-500">Trusted Platform</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {stats.map((stat, idx) => (
                  <div 
                    key={idx}
                    className="group p-5 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-blue-100 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300 text-center cursor-default"
                  >
                    <div className="text-2xl sm:text-3xl font-bold text-blue-500 group-hover:scale-110 transition-transform duration-300">
                      {stat.number}
                    </div>
