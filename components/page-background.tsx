export function PageBackground() {
    return (
        <>
            ...
            {/* Subtle Gradient Orbs - orange/orange Theme */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-[10%] right-[5%] w-[700px] h-[700px] bg-gradient-radial from-orange-500/8 to-transparent rounded-full blur-3xl shadow-[0_0_120px_rgba(139,92,246,0.12)]"></div>
