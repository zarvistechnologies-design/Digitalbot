...
export default function ServicesShowcase() {
    ...
    return (
        <section ref={storySectionRef} className="h-screen bg-gradient-to-br from-orange-50 via-orange-100/30 to-orange-50 overflow-hidden">
                        ...
                        {services.map((_, i) => (
                            <div
                                ...
                                className={`w-2 h-2 rounded-full transition-all duration-300 ${
                                    i === activeService ? 'w-6 bg-orange-600' : 'bg-gray-300'
                                }`}
                            />
                        ))}
                    </div>
