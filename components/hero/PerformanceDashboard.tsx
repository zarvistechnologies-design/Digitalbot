            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                <div className="mt-12 text-center">
                    <Link 
                        ...
                        className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-600 to-orange-700 text-white font-bold py-4 px-10 rounded-xl hover:from-orange-700 hover:to-orange-800 transition-all duration-300 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:scale-105"
                    >
