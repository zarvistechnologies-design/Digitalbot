        ...
        <main className="flex-1">
          <div className="max-w-5xl mx-auto px-6 py-12">
            ...
            <div className="text-center mb-12 relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-200/20 to-pink-200/20 blur-3xl -z-10"></div>
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-3xl shadow-2xl mb-6 transform hover:scale-110 transition-transform duration-300">
                <Shield className="w-10 h-10 text-white" />
              </div>
              <h1 className="text-5xl md:text-6xl font-black mb-4 bg-gradient-to-r from-blue-600 via-blue-500 to-pink-500 bg-clip-text text-transparent">
                Privacy Policy
              </h1>
              <p className="text-2xl text-blue-600 font-semibold mb-3">DigitalBot.ai</p>
            ...
            {/* Introduction Card */}
            <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border-l-4 border-blue-500 hover:shadow-2xl transition-shadow duration-300">
              <div className="flex items-start space-x-4">
                <div className="bg-gradient-to-br from-blue-500 to-pink-500 p-3 rounded-2xl shadow-lg shrink-0">
            ...
            {/* Important Notice */}
            <div className="bg-gradient-to-r from-blue-100 to-blue-50 rounded-3xl shadow-lg p-6 mb-12 border-2 border-blue-300 hover:border-blue-400 transition-colors duration-300">
              <div className="flex items-start space-x-4">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-3 rounded-2xl shadow-lg">
                  <Eye className="w-6 h-6 text-white" />
                </div>
                <div>
                  <p className="font-bold text-blue-900 mb-2 text-xl">Important Notice</p>
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 md:p-10 mb-8 border border-blue-100 hover:shadow-2xl transition-all duration-300">
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 md:p-10 mb-8 border border-blue-100 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                {[
                  ...
                  <div key={idx} className="group bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 border border-blue-200 hover:border-blue-400 hover:shadow-lg transition-all duration-300 cursor-pointer">
                    <div className="text-4xl mb-3">{item.icon}</div>
                    <h4 className="font-bold text-blue-700 mb-2 text-lg">{item.title}</h4>
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 md:p-10 mb-8 border border-blue-100 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="bg-gradient-to-r from-blue-100 to-blue-50 rounded-2xl p-6 mb-6 border-2 border-blue-300">
                <p className="text-blue-900 font-bold text-xl text-center flex items-center justify-center">
              ...
              <div className="space-y-5">
                {[
                  { title: '3.1 With Your Consent', desc: 'We share information when you explicitly authorize us to do so.', gradient: 'from-blue-50' },
                  ...
                  <div key={idx} className={`bg-gradient-to-r ${item.gradient} to-white rounded-2xl p-6 border-l-4 border-blue-500 hover:shadow-lg transition-all duration-300`}>
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 md:p-10 mb-8 border border-blue-100 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-4 bg-gradient-to-r from-blue-50 to-white rounded-2xl p-5 border border-blue-200 hover:border-blue-400 hover:shadow-md transition-all duration-300">
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 md:p-10 mb-8 border border-blue-100 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={idx} className="bg-gradient-to-r from-blue-50 to-white rounded-2xl p-6 border-l-4 border-blue-500 hover:shadow-lg transition-all duration-300">
                    <div className="flex items-start space-x-4">
                      <div className="text-4xl">{item.icon}</div>
                      <div className="flex-1">
                        <h3 className="font-bold text-blue-700 mb-2 text-lg">{item.title}</h3>
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-blue-100">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 pb-4 border-b-4 border-blue-500">9. Children's Privacy</h2>
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-blue-100">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 pb-4 border-b-4 border-blue-500">10. International Data Transfers</h2>
              <p className="text-gray-700 text-lg">
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-blue-100">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 pb-4 border-b-4 border-blue-500">11. Cookies and Tracking Technologies</h2>
              ...
              <div className="grid md:grid-cols-2 gap-3 mb-6">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-3 bg-blue-50 rounded-xl p-4">
              ...
              <p className="text-gray-700 text-lg">
                You can control cookie preferences through your browser settings. For more information, visit <a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline font-semibold">www.allaboutcookies.org</a>.
              </p>
            </section>

            <section className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-blue-100">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 pb-4 border-b-4 border-blue-500">12. Third-Party Links</h2>
              <p className="text-gray-700 text-lg">
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-blue-100">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 pb-4 border-b-4 border-blue-500">13. Changes to This Privacy Policy</h2>
            ...
            {/* Contact Section */}
            <section className="bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-3xl shadow-2xl p-10 mb-8 text-white">
              <div className="flex items-center space-x-4 mb-8">
              ...
              <p className="mb-8 text-xl text-blue-50">If you have questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact us:</p>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border-2 border-white/20 hover:bg-white/15 transition-colors">
                ...
                <div className="mt-6 pt-6 border-t border-white/20">
                  <p className="text-blue-100">We will respond to your inquiry within 30 days.</p>
                </div>
              </div>
            </section>

            <section className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-blue-100">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 pb-4 border-b-4 border-blue-500">15. Legal Basis for Processing (GDPR)</h2>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 border border-blue-200 hover:shadow-lg transition-shadow">
                    <div className="text-3xl mb-3">{item.icon}</div>
                    <p className="font-bold text-blue-700 mb-2 text-lg">{item.title}</p>
                    <p className="text-gray-700 text-sm">{item.desc}</p>
                  </div>
                ))}
              </div>
