...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-orange-50/30 via-white to-orange-50/20 text-gray-900">
      <Header />
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <div className="inline-flex items-center gap-2 bg-orange-100 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-orange-600 font-semibold text-sm">24/7 AI Voice Agent Support</span>
            </div>
      ...
      <section className="pb-20 px-4 relative">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 items-start">
            ...
            <Card className="border-2 border-orange-200/60 bg-gradient-to-br from-white via-orange-50/20 to-white shadow-xl shadow-orange-500/10 rounded-2xl overflow-hidden relative">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-orange-100/40 via-transparent to-transparent rounded-full blur-3xl" />
              <CardHeader className="p-8 border-b border-orange-100/50 relative z-10 bg-gradient-to-r from-orange-50/30 to-transparent">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="min-h-[120px] bg-gray-50 border-gray-200 focus:border-orange-500 focus:ring-orange-500"
                      value={form.message}
                      onChange={handleChange}
                    />
                  </div>
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white h-12 text-base font-semibold shadow-lg hover:shadow-xl transition-all"
                    disabled={loading}
                  >
            ...
            <div className="space-y-4">
              ...
              {[
                ...
                return (
                  <a
                    key={idx}
                    href={item.action}
                    className="flex items-start gap-4 p-5 bg-white border border-gray-200 rounded-xl hover:border-orange-300 hover:shadow-md transition-all group"
                  >
                    <div className="flex-shrink-0 w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
              ...
              <div className="space-y-3 pt-2">
                ...
                {/* US Office */}
                <div className="flex items-start gap-4 p-5 bg-white border border-gray-200 rounded-xl hover:border-orange-300 hover:shadow-md transition-all group">
                  <div className="flex-shrink-0 w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
                    <MapPin className="w-6 h-6 text-orange-600 group-hover:text-white transition-colors" />
                  </div>
                  <div className="flex-1">
                ...
                <CardContent className="p-5">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span className="font-semibold text-orange-600">AI Support 24/7</span>
                    </div>
