...
const benefits = [
  { icon: Zap, text: "Lightning-fast responses", description: "Get answers within 2 hours", color: "from-orange-500 to-orange-600", bgColor: "bg-orange-50" },
  ...
  { icon: Globe, text: "Global coverage", description: "Support in 50+ languages", color: "from-orange-500 to-orange-600", bgColor: "bg-orange-50" },
  { icon: Shield, text: "Enterprise security", description: "SOC2 & HIPAA compliant", color: "from-orange-500 to-orange-600", bgColor: "bg-orange-50" },
