            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'Response Time', value: '<750ms', icon: Zap, color: 'from-orange-400 to-orange-500' },
                  { label: 'Satisfaction', value: '98%', icon: Heart, color: 'from-rose-400 to-pink-500' },
                  { label: 'Cost Saved', value: '$5M+', icon: TrendingUp, color: 'from-orange-400 to-orange-500' },
                ].map((stat, i) => (
