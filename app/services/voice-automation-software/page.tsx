        ...
        <main className="min-h-screen">
          ...
          <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div className="absolute top-32 left-[15%] hidden lg:block">
              <div className="w-12 h-12 bg-white rounded-2xl shadow-lg shadow-orange-100/50 flex items-center justify-center border border-orange-100/40 animate-bounce">
                <Mic className="w-6 h-6 text-orange-600" />
              </div>
            </div>
            <div className="absolute top-48 right-[12%] hidden lg:block">
              <div className="w-10 h-10 bg-white rounded-xl shadow-lg shadow-orange-100/50 flex items-center justify-center border border-orange-100/40 animate-pulse">
                <Bot className="w-5 h-5 text-orange-500" />
              </div>
            </div>
            <div className="absolute bottom-32 left-[10%] hidden lg:block">
              <div className="w-14 h-14 bg-white rounded-2xl shadow-lg shadow-orange-100/50 flex items-center justify-center border border-orange-100/40">
                <Settings className="w-7 h-7 text-orange-600 animate-spin" style={{ animationDuration: '8s' }} />
              </div>
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div className="text-center lg:text-left">
                  {/* Badge */}
                  <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-orange-200/40 text-orange-700 px-4 py-2 rounded-full mb-6 shadow-sm">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                    ...
                    <Link 
                      href="/contact#contact-form"
                      className="inline-flex items-center justify-center gap-2 bg-white border-2 border-orange-200/40 text-orange-700 px-8 py-4 rounded-xl font-semibold hover:bg-orange-50/60 hover:border-orange-300 transition-all duration-300"
                    >
                  ...
                  <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                    <div className="flex items-center gap-2 text-sm text-gray-600 bg-white/60 px-3 py-2 rounded-lg border border-orange-100/40">
                ...
                <div className="relative hidden lg:block">
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-orange-200/40 border border-orange-100/40">
                    <Image
                  ...
                  {/* Floating Badge */}
                  <div className="absolute -top-4 -right-4 bg-white rounded-2xl px-4 py-3 shadow-xl shadow-orange-100/40 border border-orange-100/40">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-orange-100 text-sm sm:text-base">Recognition Accuracy</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl sm:text-4xl font-bold text-white mb-2">750ms</p>
                  <p className="text-orange-100 text-sm sm:text-base">Response Time</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl sm:text-4xl font-bold text-white mb-2">30+</p>
                  <p className="text-orange-100 text-sm sm:text-base">Languages Supported</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl sm:text-4xl font-bold text-white mb-2">10K+</p>
                  <p className="text-orange-100 text-sm sm:text-base">Concurrent Calls</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div className="order-1 lg:order-2">
                  <div className="inline-flex items-center gap-2 glass-card bg-orange-50/60 border border-orange-200/40 text-orange-700 px-4 py-2 rounded-full mb-6">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-3 group">
                        <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:bg-orange-500 transition-colors">
          ...
          <section className="py-20 bg-gradient-to-b from-[#fafbff] via-white to-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="text-center mb-16">
                <div className="inline-flex items-center gap-2 glass-card bg-orange-50/60 border border-orange-200/40 text-orange-700 px-4 py-2 rounded-full mb-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="group relative bg-white rounded-2xl p-6 border border-orange-100/40 shadow-lg shadow-orange-50/50 hover:shadow-xl hover:shadow-orange-100/50 hover:-translate-y-1 transition-all duration-300 overflow-hidden"
                  >
                    {/* Hover Glow Effect */}
          ...
          <section className="py-20 bg-gradient-to-b from-[#fafbff] via-white to-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <div className="max-w-3xl mx-auto">
                <div className="bg-white rounded-3xl border border-orange-100/40 shadow-xl shadow-orange-100/30 p-6 sm:p-8">
                      ...
                      >
                        ...
                        >
                          <p className={`text-xs font-semibold mb-1 ${
                            msg.speaker === "Customer" ? "text-gray-500" : "text-orange-100"
                          }`}>
                            {msg.speaker}
                          </p>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="group bg-white rounded-2xl p-6 border border-orange-100/40 shadow-lg shadow-orange-50/50 hover:shadow-xl hover:shadow-orange-100/50 hover:-translate-y-1 transition-all duration-300"
                  >
          ...
          <section className="py-20 bg-gradient-to-r from-orange-600 via-orange-700 to-violet-800 relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-orange-400/20 rounded-full blur-lg" />
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                  <Link 
                    href="/contact#contact-form"
                    className="inline-flex items-center justify-center gap-2 bg-white text-orange-700 px-8 py-4 rounded-xl font-semibold hover:bg-orange-50/60 transition-all duration-300 shadow-lg shadow-orange-900/20"
                  >
                    Get Started Free
                    <ArrowRight className="w-5 h-5" />
                  </Link>
