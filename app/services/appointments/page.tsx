            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
              ...
              <div className={`text-center lg:text-left transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <h1 id="hero-title" className="text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
                  ...
                  <span className="block bg-gradient-to-r from-orange-700 via-orange-500 to-orange-600 bg-clip-text text-transparent">Appointment Again</span>
                </h1>
          ...
          <div className={`max-w-6xl mx-auto relative z-10 transition-all duration-700 ${visibleSections.has('section-comparison') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid lg:grid-cols-2 gap-6 mb-12">
              ...
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-orange-400 to-orange-500 rounded-3xl blur-sm opacity-40 group-hover:opacity-60 transition-opacity duration-500" />
                <div className="relative bg-white rounded-3xl p-8 border border-orange-100/40 shadow-xl h-full">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={idx} className="flex items-center justify-between p-4 bg-gradient-to-r from-orange-50/60 to-orange-100/40 rounded-xl border border-orange-100/40 hover:shadow-md hover:-translate-x-1 transition-all duration-300">
                        <div className="flex items-center gap-3">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-500">
                ...
                <div className="flex justify-center gap-6 mt-2">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded-full bg-gradient-to-r from-orange-500 to-orange-600" />
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
              {[
                ...
                { label: 'Lower No-Shows', value: '77%', sublabel: 'reduction', icon: Users, color: 'orange', bg: 'from-orange-500 to-orange-600' },
        ...
        >
          <div className={`max-w-6xl mx-auto transition-all duration-700 ${visibleSections.has('section-solution') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="mt-10 text-center">
              <Link
                href="/signup?service=appointment"
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-orange-300/40 transition-all"
              >
                Get Started Free
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 relative overflow-hidden" role="region" aria-label="Interactive demo preview">
              ...
              <div className="flex items-center justify-center gap-1 h-24 mb-6" aria-hidden="true">
                {DEMO_WAVEFORM_HEIGHTS.map((bar, i) => (
                  <div 
                    key={i} 
                    className="w-1.5 bg-gradient-to-t from-orange-500 to-orange-600 rounded-full"
                    style={{
                      height: `${bar.height}%`,
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:shadow-lg hover:shadow-orange-300/40 transition-all focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
              ...
              {[
                ...
                >
                  ...
                  <figcaption className="flex items-center gap-3">
                    <div className="w-9 h-9 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-xs shadow-sm">
