  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen" role="main" suppressHydrationWarning>
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden bg-white" role="region" aria-labelledby="main-heading">
          {/* Background Elements */}
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-transparent rounded-full blur-3xl"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-6">
                ...
                <h1 id="main-heading" className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold leading-tight">
                  ...
                  <span className="text-orange-500">Conversational AI</span>
                </h1>
                ...
                <div className="flex flex-wrap gap-3">
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-xl border border-orange-100/40 shadow-md">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link href="/contact#contact-form" className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-orange-500 text-white font-bold rounded-xl shadow-lg shadow-orange-500/25 hover:shadow-xl hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
                    Get Started Free
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </Link>
                  <Link href="/contact#contact-form" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-orange-600 font-bold rounded-xl border-2 border-orange-200 shadow-lg hover:border-orange-300 hover:shadow-xl transition-all duration-300 hover:scale-105">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="bg-white/95 backdrop-blur-md p-5 rounded-2xl shadow-xl border border-orange-100/40">
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="text-center border-x border-orange-100/40">
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                ...
                <div className="text-orange-200 font-semibold text-sm uppercase tracking-wider">Accuracy Rate</div>
                <p className="mt-2 text-sm text-orange-100">Context-aware responses</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                <div className="text-4xl sm:text-5xl font-extrabold text-white mb-2">30+</div>
                <div className="text-orange-200 font-semibold text-sm uppercase tracking-wider">Languages</div>
                <p className="mt-2 text-sm text-orange-100">Multilingual support</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                <div className="text-4xl sm:text-5xl font-extrabold text-white mb-2">24/7</div>
                <div className="text-orange-200 font-semibold text-sm uppercase tracking-wider">Always Active</div>
                <p className="mt-2 text-sm text-orange-100">Never stops learning</p>
              </div>
            </div>
          </div>
        </section>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div className="relative h-full bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-100/40 shadow-lg shadow-orange-100/20 hover:shadow-xl hover:shadow-orange-200/30 hover:border-orange-200 transition-all duration-300 hover:-translate-y-1">
                    <div className="w-14 h-14 bg-orange-500 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-orange-400/30">
                ...
                <div key={index} className="group relative">
                  ...
                  <div className="relative h-full bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-orange-100/40 shadow-lg shadow-orange-100/20 hover:shadow-xl hover:shadow-orange-200/30 hover:border-orange-200 transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-14 h-14 bg-orange-500 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-400/30 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="px-3 py-1 bg-orange-500 text-white text-xs font-bold rounded-full shadow-md">{useCase.metric}</span>
                        </div>
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4">
                ...
                <span className="text-orange-500">Natural AI Conversations</span>
              </h2>
              <p className="text-gray-500 text-base sm:text-lg max-w-2xl mx-auto">
              ...
              <div className="relative bg-white/90 backdrop-blur-md rounded-3xl p-6 lg:p-8 border border-orange-100/40 shadow-xl">
                    ...
                    <div
                      ...
                      className={`p-4 rounded-2xl transition-all duration-300 ${
                        msg.speaker === "Customer"
                          ...
                          : "bg-orange-500 text-white ml-8 mr-0"
                      } ${
                        currentMessage >= idx + 1 ? "opacity-100 scale-100" : "opacity-60 scale-98"
                      }`}
                    >
                      <p className={`text-xs font-semibold mb-1 ${msg.speaker === "Customer" ? "text-orange-600" : "text-orange-100"}`}>{msg.speaker}</p>
                ...
                <div className="flex items-center justify-center">
                  <button
                    ...
                    className="group/btn flex items-center gap-3 px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white shadow-lg shadow-orange-500/25 hover:shadow-xl hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105 font-bold rounded-xl"
                  >
                    {isPlaying ? (
          ...
          <div className="container mx-auto max-w-4xl relative z-10">
            ...
            <div className="text-center mb-12 lg:mb-16">
              ...
              <h2 id="faq-section" className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4">
                <span className="text-orange-500">Frequently Asked</span>
                <span className="text-gray-900"> Questions</span>
              </h2>
              <p className="text-gray-500 text-base sm:text-lg max-w-2xl mx-auto">
                Everything you need to know about implementing <span className="text-orange-600 font-semibold">Conversational AI</span>
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              {[
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-orange-400/0 via-orange-400/0 to-orange-600/0 group-hover:from-orange-400/5 group-hover:via-orange-400/5 group-hover:to-orange-600/5 transition-all duration-300" />
          ...
          <div className="container mx-auto max-w-4xl relative z-10">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                ...
                <Link
                  href="/contact#contact-form"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-bold text-white bg-orange-500/20 backdrop-blur-sm border-2 border-orange-300/40 rounded-xl hover:bg-orange-400/30 hover:border-orange-200/60 transition-all duration-300 hover:scale-105"
                >
                  <MessageCircle className="w-5 h-5" />
                  Talk to Expert
                </Link>
