  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen" role="main" suppressHydrationWarning>
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-white via-blue-50/50 to-blue-50" role="region" aria-labelledby="main-heading">
          {/* Background Elements */}
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-20 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-blue-200 shadow-lg shadow-blue-100/50">
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                    <Sparkles className="w-3 h-3 text-white" />
                  </div>
                  <span className="text-blue-600 text-sm font-semibold">AI-Powered Conversations</span>
                </div>
                ...
                <h1 id="main-heading" className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold leading-tight">
                  ...
                  <span className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 bg-clip-text text-transparent">Conversational AI</span>
                </h1>
                ...
                <div className="flex flex-wrap gap-3">
                  <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-xl border border-blue-100 shadow-md">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link href="/signup" className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
                    Get Started Free
              ...
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-blue-200/50 via-blue-300/50 to-blue-200/50 rounded-3xl blur-2xl"></div>
                <div className="relative h-[350px] sm:h-[400px] lg:h-[500px] rounded-3xl overflow-hidden border-2 border-white shadow-2xl shadow-blue-200/50">
                  <Image
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                ...
                <div className="text-blue-200 font-semibold text-sm uppercase tracking-wider">Accuracy Rate</div>
                <p className="mt-2 text-sm text-blue-100">Context-aware responses</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                <div className="text-4xl sm:text-5xl font-extrabold text-white mb-2">30+</div>
                <div className="text-blue-200 font-semibold text-sm uppercase tracking-wider">Languages</div>
                <p className="mt-2 text-sm text-blue-100">Multilingual support</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                <div className="text-4xl sm:text-5xl font-extrabold text-white mb-2">24/7</div>
                <div className="text-blue-200 font-semibold text-sm uppercase tracking-wider">Always Active</div>
                <p className="mt-2 text-sm text-blue-100">Never stops learning</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden" role="region" aria-labelledby="features-section">
          ...
          {/* Decorative Elements */}
          <div className="absolute top-1/4 left-0 w-72 h-72 bg-blue-100/40 rounded-full blur-3xl"></div>
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-blue-500 rounded-2xl blur opacity-0 group-hover:opacity-20 transition duration-500"></div>
                  
                  <div className="relative h-full bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-blue-100 shadow-lg shadow-blue-100/20 hover:shadow-xl hover:shadow-blue-200/30 hover:border-blue-200 transition-all duration-300 hover:-translate-y-1">
                    <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-blue-400/30">
        ...
        <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden" role="region" aria-labelledby="use-cases">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(56,189,248,0.08),transparent_50%)]"></div>
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            ...
            <div className="text-center mb-12 lg:mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-blue-200 shadow-lg shadow-blue-100/50 mb-6">
                ...
                <span className="text-blue-600 text-sm font-semibold">Industry Applications</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              {useCases.map((useCase, index) => (
                <div key={index} className="group relative">
                  ...
                  <div className="relative h-full bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-blue-100 shadow-lg shadow-blue-100/20 hover:shadow-xl hover:shadow-blue-200/30 hover:border-blue-200 transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-400/30 group-hover:scale-110 transition-transform duration-300">
                        <useCase.icon className="w-7 h-7 text-white" />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="text-lg font-bold text-gray-800 group-hover:text-blue-600 transition-colors">{useCase.title}</h3>
                          <span className="px-3 py-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs font-bold rounded-full shadow-md">{useCase.metric}</span>
                        </div>
        ...
        <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          {/* Decorative */}
          <div className="absolute top-1/4 right-10 w-64 h-64 bg-blue-200/30 rounded-full blur-3xl"></div>
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-blue-200 shadow-lg shadow-blue-100/50 mb-6">
                ...
                <span className="text-blue-600 text-sm font-semibold">Live Demo</span>
              </div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4">
                <span className="text-gray-900">Experience </span>
                <span className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 bg-clip-text text-transparent">Natural AI Conversations</span>
              </h2>
              <p className="text-gray-500 text-base sm:text-lg max-w-2xl mx-auto">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/90 backdrop-blur-md rounded-3xl p-6 lg:p-8 border border-blue-100 shadow-xl">
                    ...
                    <div
                      ...
                      className={`p-4 rounded-2xl transition-all duration-300 ${
                        msg.speaker === "Customer"
                          ...
                          : "bg-gradient-to-r from-blue-500 to-blue-600 text-white ml-8 mr-0"
                      } ${
                        currentMessage >= idx + 1 ? "opacity-100 scale-100" : "opacity-60 scale-98"
                      }`}
                    >
                      <p className={`text-xs font-semibold mb-1 ${msg.speaker === "Customer" ? "text-blue-600" : "text-blue-100"}`}>{msg.speaker}</p>
                ...
                <div className="flex items-center justify-center">
                  <button
                    ...
                    className="group/btn flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105 font-bold rounded-xl"
                  >
                    {isPlaying ? (
                  ...
                  <div className="mt-8 flex items-center justify-center gap-1 h-16">
                    {Array.from({ length: 20 }).map((_, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className="w-1.5 bg-gradient-to-t from-blue-600 via-blue-400 to-blue-300 rounded-full animate-pulse"
                          style={{
                            height: `${heights[i]}px`,
        ...
        <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden" role="region" aria-labelledby="faq-section">
          ...
          <div className="absolute bottom-20 right-1/4 w-72 h-72 bg-blue-100/20 rounded-full blur-3xl"></div>
          ...
          <div className="container mx-auto max-w-4xl relative z-10">
            ...
            <div className="text-center mb-12 lg:mb-16">
              ...
              <h2 id="faq-section" className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4">
                <span className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 bg-clip-text text-transparent">Frequently Asked</span>
                <span className="text-gray-900"> Questions</span>
              </h2>
              <p className="text-gray-500 text-base sm:text-lg max-w-2xl mx-auto">
                Everything you need to know about implementing <span className="text-blue-600 font-semibold">Conversational AI</span>
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              {[
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-400/0 via-blue-400/0 to-blue-500/0 group-hover:from-blue-400/5 group-hover:via-blue-400/5 group-hover:to-blue-500/5 transition-all duration-300" />
