  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#fafbff] via-white to-[#f0f0ff] overflow-hidden">
      ...
      <main className="flex-1">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
              ...
              <div className={`text-center lg:text-left transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="inline-flex items-center gap-2 glass-card bg-orange-50/60 border border-orange-200/40 px-3 py-1.5 rounded-full mb-6">
                  ...
                  <span className="text-sm font-semibold text-orange-700">AI-Powered Reception</span>
                </div>
                ...
                <h1 className="text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
                  ...
                  <span className="block bg-gradient-to-r from-orange-700 via-orange-500 to-orange-600 bg-clip-text text-transparent">That Never Sleeps</span>
                </h1>
                ...
                <div className="bg-gradient-to-r from-orange-50/60 to-orange-50/40 border border-orange-200/40 rounded-2xl p-5 mb-6">
                  ...
                  <p className="text-orange-600 font-bold text-base uppercase tracking-wider">Let AI Answer Every Call 24/7.</p>
                </div>

                {/* Description */}
                <p className="text-gray-600 text-base lg:text-lg mb-6 leading-relaxed max-w-xl mx-auto lg:mx-0">
                  Your AI-powered virtual receptionist answers every call, books appointments, routes inquiries, and handles customer service — <strong className="text-orange-600">24/7, in 30+ languages, without human effort</strong>.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <Link
                    href="/contact#contact-form"
                    className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-orange-600 bg-white border-2 border-orange-500 rounded-xl hover:bg-orange-50/60 transition-all duration-300 hover:scale-105 shadow-md"
                  >
              ...
              <div className={`relative transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <div className="relative h-[400px] lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl shadow-orange-500/20 border border-orange-200/40">
                  <Image
                    ...
                    <div className="bg-white/95 backdrop-blur-md rounded-xl p-4 border border-orange-200/40 shadow-lg">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-orange-600">Handling calls right now</div>
                        </div>
                      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
              {features.map((feature, index) => {
                ...
                return (
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="flex items-end justify-between">
                        <div className="bg-white/95 backdrop-blur-sm rounded-lg px-3 py-1.5">
                          <div className="text-2xl font-bold text-orange-600">{feature.stat}</div>
                  ...
                  <div className="p-6">
                    <h3 className="text-lg font-bold mb-2 text-gray-900 group-hover:text-orange-600 transition-colors">
                      {feature.title}
                    </h3>
                ...
                {benefits.map((benefit, index) => (
                  <button
                    ...
                    className={`w-full text-left p-6 rounded-2xl border-2 transition-all duration-300 ${
                      activeUseCase === index
                        ? 'bg-gradient-to-br from-orange-50/60 to-orange-50/40 border-orange-300/40 shadow-lg'
                  ...
                  <div className={`relative ${
                    ...
                    <div className="absolute inset-0 p-8 flex flex-col justify-end">
                      <div className="bg-white/95 backdrop-blur-sm rounded-full w-12 h-12 flex items-center justify-center mb-4 shadow-lg">
                        <BlockIcon className="w-6 h-6 text-orange-600" />
                      </div>
              ...
              {useCases.map((useCase, index) => (
                <div
                  ...
                  className={`group relative bg-gradient-to-br ${
                    index === 0 ? 'from-orange-50/60 to-orange-100/60' :
                    index === 1 ? 'from-orange-50 to-orange-100' :
                    index === 2 ? 'from-orange-50/40 to-orange-100/40' :
                ...
                >
                  <div className={`grid md:grid-cols-2 gap-0 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                    ...
                    <div className={`relative h-64 md:h-80 overflow-hidden ${index % 2 === 1 ? 'md:order-2' : ''}`}>
                      <Image
                        src={index === 0? "/images/healthcare.png": index === 3? "/images/retail.png": `https://images.unsplash.com/photo-${index === 1 ? '1507003211169-0a1dd7228f2d' : '1581091226825-a6a2a5aee158'}?q=80&w=1200&auto=format&fit=crop`}
                      ...
                      <div className="absolute top-6 right-6 w-16 h-16 rounded-2xl bg-white/95 backdrop-blur-sm shadow-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-500">
                        <span className={`text-3xl font-bold bg-gradient-to-br ${
                          index === 0 ? 'from-orange-600 to-orange-500' :
                          index === 1 ? 'from-orange-600 to-orange-500' :
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-4">
              {[
                ...
                <details
                  key={index}
                  className="group bg-white rounded-2xl border border-gray-200 hover:border-orange-300/40 transition-all duration-300 overflow-hidden shadow-sm hover:shadow-lg"
                >
        ...
        {/* Call to Action */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-600 via-orange-500 to-orange-700 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl text-center relative z-10">
            ...
            <p className="text-orange-50 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link href="/contact#contact-form">
                <Button size="lg" className="group bg-white text-orange-600 hover:bg-gray-50 px-8 py-6 text-lg font-bold shadow-2xl hover:shadow-white/30 transition-all duration-300 hover:scale-105">
                  Get Started Free
