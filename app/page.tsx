  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen" role="main" suppressHydrationWarning>
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-orange-50 to-orange-100 overflow-hidden">
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-orange-500/15 to-orange-500/15 border border-orange-400/30 backdrop-blur-sm mb-6">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-orange-600 via-orange-500 to-orange-500 glass-heading">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-16">
              ...
              {/* Core AI Engine */}
              <div className="group relative bg-gradient-to-br from-orange-500/10 to-orange-500/10 backdrop-blur-xl rounded-3xl p-8 border border-orange-400/20 hover:border-orange-400/40 transition-all duration-500 hover:shadow-2xl hover:shadow-orange-500/20 hover:-translate-y-2">
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-500 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-lg shadow-orange-500/40">
              ...
              <div className="group relative bg-gradient-to-br from-orange-500/10 to-orange-500/10 backdrop-blur-xl rounded-3xl p-8 border border-orange-400/20 hover:border-orange-400/40 transition-all duration-500 hover:shadow-2xl hover:shadow-orange-500/20 hover:-translate-y-2">
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-500 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-lg shadow-orange-500/50">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {['Salesforce', 'HubSpot', 'Slack', 'Zendesk', 'Shopify', 'Stripe'].map((app, i) => (
                      <span key={i} className="px-3 py-1.5 rounded-full bg-orange-500/10 border border-orange-400/30 text-xs text-orange-700 font-medium backdrop-blur-sm">
                        {app}
                      </span>
                    ))}
                  </div>
                  
                  <div className="text-sm text-orange-700/70 font-medium">
            ...
            <div className="relative bg-gradient-to-br from-white via-orange-50 to-orange-100 backdrop-blur-2xl rounded-3xl p-12 border border-orange-200/60 overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-3 mb-10">
                  {[
                    { icon: '📞', label: 'Voice AI', color: 'from-orange-500 to-orange-500' },
                    { icon: '💬', label: 'Live Chat', color: 'from-orange-500 to-orange-500' },
                    { icon: '📧', label: 'Email AI', color: 'from-emerald-500 to-teal-500' },
                    { icon: '📱', label: 'SMS Bot', color: 'from-orange-500 to-orange-500' },
                    { icon: '📊', label: 'Analytics', color: 'from-rose-500 to-pink-500' },
                    { icon: '🔗', label: 'API Access', color: 'from-orange-500 to-orange-500' }
                  ].map((feature, i) => (
                    <div key={i} className="group flex items-center gap-2 px-5 py-3 rounded-full bg-gradient-to-r hover:scale-105 transition-transform duration-300 cursor-default shadow-lg" style={{ background: `linear-gradient(135deg, ${feature.color.includes('orange') ? '#f97316' : feature.color.includes('orange') ? '#8b5cf6' : feature.color.includes('emerald') ? '#10b981' : feature.color.includes('amber') ? '#f59e0b' : feature.color.includes('rose') ? '#f43f5e' : '#6366f1'}, ${feature.color.includes('cyan') ? '#06b6d4' : feature.color.includes('orange') ? '#a855f7' : feature.color.includes('teal') ? '#14b8a6' : feature.color.includes('orange') ? '#f97316' : feature.color.includes('pink') ? '#ec4899' : '#f97316'})` }}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <a href="#contact-form" className="group px-8 py-4 rounded-full bg-gradient-to-r from-orange-500 to-orange-500 text-white font-bold text-lg shadow-2xl shadow-orange-500/40 hover:shadow-orange-500/60 hover:scale-105 transition-all duration-300 flex items-center gap-3">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              {[
                ...
                <div key={i} className="text-center p-6 rounded-2xl bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-orange-400/20 backdrop-blur-sm hover:border-orange-400/40 transition-all duration-300">
                  <div className="text-3xl mb-2">{stat.icon}</div>
                  <div className="text-3xl lg:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-orange-500 mb-2">
                    {stat.value}
                  </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 via-white to-orange-50 relative overflow-hidden" role="region" aria-labelledby="voice-search-qa">
          {/* CSS Animations */}
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="space-y-8 flex flex-col">
                ...
                <div className="qa-card group bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-2xl p-6 border border-orange-200 shadow-sm hover:shadow-xl hover:border-orange-300 transition-all duration-300 hover:-translate-y-1 h-[480px] flex flex-col" style={{ animationDelay: '0.3s' }}>
                  <div className="flex items-start gap-4 mb-5">
                    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-orange-500 flex items-center justify-center text-white font-bold shadow-lg shadow-orange-500/25 group-hover:scale-110 transition-transform">
                      Q3
                    </div>
                    <h3 className="text-gray-900 font-bold text-lg leading-snug pt-2 group-hover:text-orange-600 transition-colors">
                  ...
                  <div className="pl-16 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3 pt-4 border-t border-orange-200">
                      ...
                      <div className="text-center p-3 bg-gradient-to-b from-white to-orange-50 rounded-xl border border-amber-200 hover:shadow-md transition-all">
              ...
              <div className="space-y-8 flex flex-col">
                ...
                {/* Q&A 4 */}
                <div className="qa-card group bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-2xl p-6 border border-amber-200 shadow-sm hover:shadow-xl hover:border-amber-300 transition-all duration-300 hover:-translate-y-1 h-[480px] flex flex-col" style={{ animationDelay: '0.15s' }}>
                  <div className="flex items-start gap-4 mb-5">
                    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-orange-500 flex items-center justify-center text-white font-bold shadow-lg shadow-amber-500/25 group-hover:scale-110 transition-transform">
                      Q4
                    </div>
                    <h3 className="text-gray-900 font-bold text-lg leading-snug pt-2 group-hover:text-orange-600 transition-colors">
        ...
        <section className="py-6 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 via-orange-100/30 to-orange-50 relative" role="region" aria-labelledby="faq-section">
          ...
          <div className="container mx-auto max-w-5xl relative z-10">
            ...
            <div className="text-center mb-6">
              ...
              <h2 id="faq-section" className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                Frequently Asked{' '}
                <span className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-600 bg-clip-text text-transparent">
                  Questions
                </span>
              </h2>
            ...
            <div className="mt-12 text-center">
              <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-gradient-to-r from-orange-50 to-orange-50 rounded-2xl p-6 sm:p-8 border border-orange-100">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center px-6 py-3 text-sm font-bold text-white bg-gradient-to-r from-orange-500 via-orange-600 to-orange-600 rounded-xl shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all duration-300 hover:scale-105"
                >
                  Get in Touch
