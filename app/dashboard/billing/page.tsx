...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .meta-dot.orange { background: #a78bfa; box-shadow: 0 0 6px rgba(167,139,250,0.5); }
  ...
  .tile-icon.orange { background: #f3e8ff; }
  .tile-icon.orange svg { fill: #7c3aed; }
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2.5 text-lg font-bold text-center border border-slate-300 rounded-lg focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all"
                    />
                  </div>
                  <button
