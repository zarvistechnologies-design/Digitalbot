...
function DoctorCard({
  ...
  return (
    ...
    >
      {isSelected && (
        <div className="absolute -top-2 -right-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full p-1.5">
          <CheckCircle2 className="h-4 w-4 text-white" />
        </div>
      )}
      
      <div className="flex items-start gap-4">
        <div className={`rounded-xl p-3 ${isSelected ? "bg-gradient-to-br from-blue-500 to-purple-500" : "bg-gray-100"}`}>
                  ...
                  <div className="p-5 space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min={getMinDate()}
                        className="w-full max-w-xs px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-lg"
                      />
                    </div>
                    ...
                    <>
                      ...
                      {selectedDoctor.allowMultipleBookings && (
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-semibold text-blue-600">{selectedDoctor.maxPatientsPerSlot}</span>
                        </div>
                      )}
                    </>
                  )}
