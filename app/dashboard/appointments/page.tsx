          ...
          <div className="relative overflow-hidden bg-white border-2 border-gray-200 rounded-2xl">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg mb-4">
                <div className="p-2 bg-gradient-to-br from-orange-500 to-orange-500 rounded-full">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-orange-700 to-orange-700 opacity-0 group-hover:opacity-100 transition-opacity"></div>
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-orange-50">
      ...
      <main className="flex-1 ml-64 p-8">
        <div className="max-w-[1600px] mx-auto space-y-6">
          ...
          {/* Doctor Info Header */}
          <div className="bg-gradient-to-r from-orange-600 to-orange-600 rounded-2xl shadow-xl p-6 text-white">
            <div className="flex items-center gap-4">
                      ...
                      >
                        <div className="flex gap-4">
                          ...
                          <div className="flex-shrink-0">
                            <div className="bg-gradient-to-br from-orange-500 to-orange-500 p-4 rounded-2xl shadow-lg group-hover:scale-110 transition-transform">
