...
import { ArrowRight, Calendar, HeartPulse, MessageSquare, Pill, Shield } from "lucide-react"
...
const chatMessages = [
  { from: "user", text: "Hi, I need to book an appointment with Dr. Sharma" },
  { from: "bot", text: "Welcome to CareFirst Clinic! 🏥 I can help you book. Dr. Sharma specializes in:\n• General Medicine\n• Diabetes Management\n• Thyroid Care\n\nIs this a new or follow-up visit?" },
  { from: "user", text: "New visit, diabetes check" },
  { from: "bot", text: "Dr. Sharma's available slots:\n📅 Today 5:30 PM\n📅 Tomorrow 10:00 AM\n📅 Tomorrow 4:00 PM\n\nConsultation fee: ₹800\nWhich slot works for you?" },
  { from: "user", text: "Tomorrow 10 AM" },
  { from: "bot", text: "✅ Appointment confirmed!\n👨‍⚕️ Dr. Sharma\n📅 Tomorrow, 10:00 AM\n📍 CareFirst Clinic, MG Road\n💰 Fee: ₹800\n\n📋 Please bring:\n• Previous reports\n• Insurance card\n\nSee you tomorrow! 🙏" },
]

const features = [
  { icon: Calendar, title: "Appointment Booking", desc: "Patients book appointments with specific doctors via WhatsApp — 24/7, no calls needed." },
  { icon: MessageSquare, title: "Symptom Pre-Screening", desc: "AI collects symptoms before the visit so doctors have context and save consultation time." },
  { icon: Pill, title: "Prescription Reminders", desc: "Automated medication reminders, refill alerts, and follow-up appointment scheduling." },
  { icon: Shield, title: "Insurance Verification", desc: "Verify insurance coverage, share documents, and process claims — all via WhatsApp." },
]
      ...
      <main className="bg-white text-gray-900 min-h-screen overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center">
            <div className={`space-y-8 transition-all duration-1000 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
              <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-full">
                ...
                <span className="text-sm text-emerald-400 font-medium">Built For Healthcare</span>
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                Automate Patient<br />
                <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">Bookings & Follow-Ups</span>
              </h1>
              <p className="text-lg text-gray-600 max-w-xl">Our WhatsApp AI books appointments, sends reminders, collects symptoms, and handles patient queries — 24/7.</p>
                  ...
                  <div className="bg-slate-900 rounded-[44px] border-[6px] border-slate-700 p-1 shadow-2xl">
                    <div className="mx-auto w-28 h-6 bg-slate-900 rounded-b-2xl relative z-10" />
                      ...
                      <div className="bg-emerald-600 px-3 py-3 flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center text-white text-[10px] font-bold">CF</div>
                        <div><p className="text-white text-sm font-semibold">CareFirst Clinic</p><p className="text-emerald-200 text-xs">● Verified Business</p></div>
                      </div>
        ...
        <section className="py-16 bg-gradient-to-r from-emerald-50 via-emerald-100/50 to-emerald-50 border-y border-emerald-200">
          <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            {[{ end: 60, suffix: "%", label: "Fewer No-Shows" }, { end: 3, suffix: "s", label: "Avg Response Time" }, { end: 500, suffix: "+", label: "Patients Served" }, { end: 24, suffix: "/7", label: "Patient Support" }].map((s, i) => (
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Advantages of Using <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">Our AI</span></h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="group relative">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm" />
                <div className="relative bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 h-full">
                  {/* Large Visual Emoji */}
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-emerald-500/25 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Instant Appointment Booking</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Patients book appointments via WhatsApp anytime — no waiting on hold, no busy phone lines. Doctor availability shown in real-time.</p>
                </div>
              </div>
              {/* Card 2 */}
              <div className="group relative">
                ...
                <div className="relative bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Automated Reminders & Follow-ups</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Reduce no-shows by 45% with automated appointment reminders, pre-visit instructions, and post-consultation follow-ups.</p>
                </div>
              </div>
              {/* Card 3 */}
              <div className="group relative">
                ...
                <div className="relative bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Patient Query Resolution 24/7</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Common questions about timings, doctor availability, lab reports, and billing are handled instantly — freeing your reception staff.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-16 relative">
              <div className="bg-gradient-to-r from-emerald-400 to-teal-400 rounded-3xl p-8 sm:p-12 relative overflow-hidden">
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-400 via-emerald-300 to-teal-400" />
                ...
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">Missed Calls = Missed Patients</h3>
                      <div className="space-y-2.5">
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-gray-700">Without AI:</span> 200+ calls daily, 30-40% unanswered during peaks</p>
                        </div>
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-emerald-700">With AI:</span> AI answers every single inquiry instantly</p>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="h-1 bg-gradient-to-r from-emerald-400 to-teal-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
              </div>
              <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">No-Show Epidemic</h3>
                      <div className="space-y-2.5">
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-emerald-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-emerald-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-gray-700">Without AI:</span> 15-20% revenue lost to no-shows</p>
                        </div>
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-emerald-700">With AI:</span> Smart reminders + easy WhatsApp rescheduling</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">Manual Record Requests</h3>
                      <div className="space-y-2.5">
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-emerald-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-emerald-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-gray-700">Without AI:</span> Staff hours spent on lab reports, prescriptions, bills calls</p>
                        </div>
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-emerald-700">With AI:</span> AI delivers documents on WhatsApp instantly</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">After-Hours Patient Anxiety</h3>
                      <div className="space-y-2.5">
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-emerald-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-emerald-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-gray-700">Without AI:</span> Health concerns at night, clinic is closed</p>
                        </div>
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-emerald-700">With AI:</span> AI provides guidance, schedules urgent appointments</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">You With AI <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">vs</span> Competitors Without</h2>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-x-auto">
              ...
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-100">
                ...
                <div className="col-span-5 p-5 bg-gradient-to-r from-emerald-400 to-teal-400 text-center">
              ...
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-50 last:border-0 group hover:bg-emerald-50/10 transition-colors">
                <div className="col-span-1 flex items-center justify-center p-4">
                  <span className="w-7 h-7 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">1</span>
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  <span className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                  </span>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">Multi-doctor, multi-location scheduling from one bot</p>
                </div>
                <div className="col-span-1 flex items-center justify-center">
                ...
                <div className="col-span-5 p-5 flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">Single-doctor basic appointment form</p>
                </div>
              </div>
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-50 last:border-0 group hover:bg-emerald-50/10 transition-colors">
                <div className="col-span-1 flex items-center justify-center p-4">
                  <span className="w-7 h-7 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">2</span>
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  <span className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                  </span>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">Full patient journey: booking → forms → follow-up</p>
                </div>
                <div className="col-span-1 flex items-center justify-center">
                  <div className="w-px h-8 bg-gray-200" />
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">Just appointment booking, nothing else</p>
                </div>
              </div>
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-50 last:border-0 group hover:bg-emerald-50/10 transition-colors">
                <div className="col-span-1 flex items-center justify-center p-4">
                  <span className="w-7 h-7 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">3</span>
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  <span className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                  </span>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">HIPAA-aware conversations with encrypted data</p>
                </div>
                <div className="col-span-1 flex items-center justify-center">
                  <div className="w-px h-8 bg-gray-200" />
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">Generic chatbot with zero privacy focus</p>
                </div>
              </div>
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-50 last:border-0 group hover:bg-emerald-50/10 transition-colors">
                <div className="col-span-1 flex items-center justify-center p-4">
                  <span className="w-7 h-7 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">4</span>
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  <span className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                  </span>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">Lab reports & prescriptions delivered on WhatsApp</p>
                </div>
                <div className="col-span-1 flex items-center justify-center">
                  <div className="w-px h-8 bg-gray-200" />
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">"Visit the clinic to collect reports"</p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-emerald-50 to-white border border-emerald-200 rounded-3xl p-10 sm:p-14">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to automate your clinic?</h2>
            <p className="text-gray-600 mb-8">See how our AI handles appointments and patient communication.</p>
