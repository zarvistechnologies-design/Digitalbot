...
import { ArrowRight, Calendar, Car, DollarSign, MessageSquare, Users } from "lucide-react"
...
const chatMessages = [
  { from: "user", text: "Hi, I'm looking for a new SUV" },
  { from: "bot", text: "Welcome to AutoPrime Motors! 🚗 I'd love to help. What's your budget range?\n• Under ₹10L\n• ₹10-20L\n• ₹20-40L\n• Above ₹40L" },
  { from: "user", text: "₹15-20 lakhs" },
  { from: "bot", text: "Great range! Here are our top SUVs in that budget:\n🚙 Hyundai Creta — ₹16.5L\n🚙 Kia Seltos — ₹17.2L\n🚙 Tata Harrier — ₹18.8L\nWant details on any?" },
  { from: "user", text: "Creta details" },
  { from: "bot", text: "Hyundai Creta SX(O)\n🔹 1.5L Turbo Petrol\n🔹 Panoramic Sunroof\n🔹 ADAS Safety Suite\n🔹 Ventilated Seats\n💰 On-road: ₹18.2L\nWant to book a test drive?" },
  { from: "user", text: "Yes, this Saturday" },
  { from: "bot", text: "✅ Test drive confirmed!\n📅 Saturday, 11:00 AM\n📍 AutoPrime Motors, MG Road\nOur sales advisor Amit will have the Creta ready. See you! 🎉" },
]

const features = [
  { icon: MessageSquare, title: "Instant Inquiry Response", desc: "Answer questions about models, variants, pricing, and availability 24/7 on WhatsApp." },
  { icon: Calendar, title: "Test Drive Booking", desc: "Customers book test drives directly through chat — no calls, no waiting." },
  { icon: DollarSign, title: "EMI & Finance Info", desc: "Share EMI calculators, finance options, and on-road prices instantly." },
  { icon: Users, title: "Lead Qualification", desc: "AI qualifies budget, model preference and timeline before passing to your sales team." },
]
    ...
    <>
      ...
      <main className="bg-white text-gray-900 min-h-screen overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center">
            <div className={`space-y-8 transition-all duration-1000 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
              <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 px-4 py-2 rounded-full">
                ...
                <span className="text-sm text-orange-400 font-medium">Built For Car Dealerships</span>
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                Turn Every Inquiry Into a<br />
                <span className="bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent">Test Drive Booking</span>
              </h1>
              <p className="text-lg text-gray-600 max-w-xl">Our WhatsApp AI Agent handles every car inquiry, shares specs & pricing, and books test drives — even after showroom hours.</p>
                  ...
                  <div className="bg-slate-900 rounded-[44px] border-[6px] border-slate-700 p-1 shadow-2xl">
                    <div className="mx-auto w-28 h-6 bg-slate-900 rounded-b-2xl relative z-10" />
                      ...
                      <div className="bg-orange-600 px-3 py-3 flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-orange-500 flex items-center justify-center text-white text-[10px] font-bold">AP</div>
                        <div><p className="text-white text-sm font-semibold">AutoPrime Motors</p><p className="text-orange-200 text-xs">● Verified Business</p></div>
                      </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-12">What Our AI Does For Your Dealership</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-orange-50 via-orange-100/50 to-orange-50 border-y border-orange-200">
          <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            {[{ end: 55, suffix: "%", label: "More Test Drives" }, { end: 3, suffix: "s", label: "Avg Response Time" }, { end: 40, suffix: "%", label: "Higher Conversion" }, { end: 24, suffix: "/7", label: "Lead Coverage" }].map((s, i) => (
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Advantages of Using <span className="bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent">Our AI</span></h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="group relative">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-400 to-amber-400 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm" />
                <div className="relative bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 h-full">
                  {/* Large Visual Emoji */}
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-400 to-amber-400 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-orange-500/25 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Instant Vehicle Information</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Every inquiry gets immediate specs, pricing, variants, and on-road price details — no waiting for a sales exec to call back from their desk.</p>
                </div>
              </div>
              {/* Card 2 */}
              <div className="group relative">
                ...
                <div className="relative bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Automated Test Drive Booking</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Customers book test drives via WhatsApp chat. Pick model, date, time — done. Your team sees the schedule, customer sees confirmation.</p>
                </div>
              </div>
              {/* Card 3 */}
              <div className="group relative">
                ...
                <div className="relative bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">EMI & Finance Calculator on Chat</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Customers get instant EMI calculations, down payment options, and finance partner details right in the WhatsApp conversation.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-16 relative">
              <div className="bg-gradient-to-r from-orange-400 to-amber-400 rounded-3xl p-8 sm:p-12 relative overflow-hidden">
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-orange-400 via-orange-300 to-amber-400" />
                ...
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">Weekend Inquiries Get Lost</h3>
                      <div className="space-y-2.5">
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-gray-700">Without AI:</span> 60% car buyers browse weekends — showroom is packed</p>
                        </div>
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-orange-700">With AI:</span> AI engages every digital inquiry instantly, anytime</p>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="h-1 bg-gradient-to-r from-orange-400 to-amber-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
              </div>
              <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">No Follow-Up After Visit</h3>
                      <div className="space-y-2.5">
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-orange-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-gray-700">Without AI:</span> Test drive done, no follow-up for 3 days</p>
                        </div>
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-orange-700">With AI:</span> AI follows up within hours automatically</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">Sales Team Busy With Paperwork</h3>
                      <div className="space-y-2.5">
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-orange-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-gray-700">Without AI:</span> Best salespeople stuck doing documentation</p>
                        </div>
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-orange-700">With AI:</span> AI handles qualification so they focus on selling</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div className="p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">Lost Service Revenue</h3>
                      <div className="space-y-2.5">
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-orange-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-gray-700">Without AI:</span> Customers forget service schedules, go elsewhere</p>
                        </div>
                        <div className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg className="w-3 h-3 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                          </span>
                          <p className="text-sm text-gray-500 leading-relaxed"><span className="font-medium text-orange-700">With AI:</span> Automated service reminders keep them coming back</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">You With AI <span className="bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent">vs</span> Competitors Without</h2>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-x-auto">
              ...
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-100">
                ...
                <div className="col-span-5 p-5 bg-gradient-to-r from-orange-400 to-amber-400 text-center">
              ...
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-50 last:border-0 group hover:bg-orange-50/10 transition-colors">
                <div className="col-span-1 flex items-center justify-center p-4">
                  <span className="w-7 h-7 bg-gradient-to-br from-orange-400 to-amber-400 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">1</span>
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  <span className="w-5 h-5 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                  </span>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">Send car photos, 360° views, brochures in chat</p>
                </div>
                <div className="col-span-1 flex items-center justify-center">
                ...
                <div className="col-span-5 p-5 flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">"Visit our website" — customer never goes</p>
                </div>
              </div>
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-50 last:border-0 group hover:bg-orange-50/10 transition-colors">
                <div className="col-span-1 flex items-center justify-center p-4">
                  <span className="w-7 h-7 bg-gradient-to-br from-orange-400 to-amber-400 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">2</span>
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  <span className="w-5 h-5 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                  </span>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">AI knows cars — variants, features, competitor specs</p>
                </div>
                <div className="col-span-1 flex items-center justify-center">
                  <div className="w-px h-8 bg-gray-200" />
                </div>
              ...
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-50 last:border-0 group hover:bg-orange-50/10 transition-colors">
                <div className="col-span-1 flex items-center justify-center p-4">
                  <span className="w-7 h-7 bg-gradient-to-br from-orange-400 to-amber-400 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">3</span>
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  <span className="w-5 h-5 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                  </span>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">Post-sale: insurance, service booking, accessories</p>
                </div>
                <div className="col-span-1 flex items-center justify-center">
                  <div className="w-px h-8 bg-gray-200" />
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">Engagement stops after the transaction</p>
                </div>
              </div>
              <div className="grid grid-cols-12 min-w-[600px] border-b border-gray-50 last:border-0 group hover:bg-orange-50/10 transition-colors">
                <div className="col-span-1 flex items-center justify-center p-4">
                  <span className="w-7 h-7 bg-gradient-to-br from-orange-400 to-amber-400 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">4</span>
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  <span className="w-5 h-5 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                  </span>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">Customer buys from WhatsApp conversation itself</p>
                </div>
                <div className="col-span-1 flex items-center justify-center">
                  <div className="w-px h-8 bg-gray-200" />
                </div>
                <div className="col-span-5 p-5 flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">Customer must call or visit showroom</p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-orange-50 to-white border border-orange-200 rounded-3xl p-10 sm:p-14">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to sell more cars?</h2>
            <p className="text-gray-600 mb-8">See how our AI handles inquiries for your dealership.</p>
